...
## Some benefits of using barplotOr
...
Occurrences of letters from the main page of Wikipedia. Please note that this is just an example to illustrate the use of barplotOr, do not interprate the results as letters have been modified to the need of this vignette. They do not represent the real occurrences of letters.
